...
namespace OpenTKTutorial
{
    ...
    public static class EasingFunctions
    {
        ...
        /// <returns>The new value after the easing function has ran.</returns>
        public static double EaseOutBounce(double t, double b, double c, double d)
        {
            ...
            {
                return t < 0.90909090909090909090909090909091
                    ? (c * ((7.5625 * (t -= 0.81818181818181818181818181818182) * t) + 0.9375)) + b
                    : (c * ((7.5625 * (t -= 0.9) * t) + 0.95454545454545454545454545454545)) + b;
            }
        }
